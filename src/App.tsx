  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-amber-500 selection:text-slate-950">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-8 space-y-6">
        ...
        {/* Primary Copyable Subject Box */}
        <SubjectOutputBox ackNo={ackNo} bankName={bankName} />

        {/* Editable Fields for ACK No and Bank Name */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-950 border border-slate-700 rounded-xl text-base font-mono font-bold text-amber-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-950 border border-slate-700 rounded-xl text-base font-semibold text-slate-100 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition"
              />
            </div>
          </div>
        </div>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-6 text-center text-xs text-slate-500">
        <div className="flex items-center justify-center space-x-1.5">
          ...
          <span>Notice ACK & Bank Email Subject Generator</span>
        </div>
      </footer>
